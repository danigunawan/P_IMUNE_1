...
DROP DATABASE IF EXISTS `imunisasi`;
...
-- Dumping data for table imunisasi.categories: ~1 rows (approximately)
...
-- Dumping data for table imunisasi.pages: ~3 rows (approximately)
DELETE FROM `pages`;
...
INSERT INTO `settings` (`id`, `key_name`, `key_value`, `meaning`, `modified`) VALUES
	...
	(7, 'app_author', 'Andrzej Żukowski &copy; 2016', 'aplikasi web penulis', '2017-03-24 21:10:52'),
	(8, 'app_domain', 'http://localhost/imunisasi/', 'layanan domain internet', '2017-03-24 21:10:52'),
	(9, 'app_footer', '<a href="http://swoja-strona.eu" target="_blank" class="footer-link">&copy; 2016 MyCMS</a>', 'layanan konten footer', '2017-03-24 21:10:52'),
	...
	(23, 'email_host', 'mail.domain.pl', 'tuan rumah mengirim email', '2017-03-24 21:10:52'),
	(24, 'email_port', '587', 'port smtp', '2017-03-24 21:10:52'),
	(25, 'email_password', '', 'password account mailing', '2017-03-24 21:10:52'),
	...
	(31, 'email_report_subject', 'Raport serwisu', 'pelaporan surat tentang acara tersebut', '2017-03-24 21:10:52'),
	(32, 'email_report_body', 'Raport o zdarzeniu w serwisie', 'e-mail rapotującego teks', '2017-03-24 21:10:52'),
	(33, 'email_password_subject', 'Nowe hasło do konta', 'topik yang dihasilkan email dengan password baru', '2017-03-24 21:10:52'),
	(34, 'email_password_body', 'Na Twoją prośbę przesyłamy Ci nowe hasło logowania. Oto Twoje dane:', 'konten yang dihasilkan email dengan password baru', '2017-03-24 21:10:52');
...
INSERT INTO `users` (`id`, `login`, `password`, `email`, `role`, `active`, `logged_in`, `token`) VALUES
	(1, 'dhanexlab', '2c614e5cf864ba613d2005c1e9b3589e19c22686', 'dhanexlab@gmail.com', 1, 1, '2017-03-25 04:11:34', '50055e084bf3de3c8906d3fb75bd91943b672a926018c69f14d929c9a070c345');
...
-- Dumping data for table imunisasi.visitors: ~12 rows (approximately)
