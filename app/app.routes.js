...
.config(['$routeProvider', '$locationProvider', 'ngMetaProvider', function($routeProvider, $locationProvider, ngMetaProvider) {
    ...
    ngMetaProvider.setDefaultTitle('IMUNISASI PROJECT');
    ngMetaProvider.setDefaultTitleSuffix(' | Project Imunisasi - Learning & Integration System Imune');
    ngMetaProvider.setDefaultTag('author', 'Dani Gunawan');
